...
|measurementType|‘char’ - Mandatory parameter. It points to the folder where the trace is loaded from. The input folder is "siteID/measurementType". The output folder for the cleaned trace is "siteID/measurementType/clean". |
